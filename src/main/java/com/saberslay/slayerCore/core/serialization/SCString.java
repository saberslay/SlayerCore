...
public class SCString extends SCBase {
	...
	public static SCString Create(String name, String data) {
		SCString string = new SCString();
		string.setName(name);
	...
	public static SCString Deserialize(byte[] data, int pointer) {
		byte containerType = data[pointer++];
		assert(containerType == CONTAINER_TYPE);
		
		SCString result = new SCString();
